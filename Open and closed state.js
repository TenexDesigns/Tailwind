The example youve provided is using the <details> HTML element, which is used for creating a disclosure widget in which information is visible only when the widget is toggled into an "open" state. A <details> element typically comes with a <summary> element that represents the label for the disclosure widget.
...
Heres a breakdown of what each class does:
...
Heres a breakdown of the classes used in the example:
