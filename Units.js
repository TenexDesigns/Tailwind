...
px (pixels): Represents a fixed length in pixels. It is relative to the screens resolution. 1 pixel is equal to 1/96th of an inch.
...
vmin: Represents a length relative to 1% of the viewports smaller dimension (either width or height).
vmax: Represents a length relative to 1% of the viewports larger dimension.
...
Note: The em and rem units are particularly useful for achieving scalability in layouts, as they are based on the font-size and root elements font-size, respectively. The viewport-based units (vw, vh, vmin, vmax) are useful for creating responsive designs based on the browser window's dimensions.
